...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("quiz/application/icons/quiz.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 1440, 392);
        add(l1);
        
        qno = new JLabel("");
        qno.setFont(new Font("Segoe Print", Font.BOLD, 24));
        qno.setBounds(100, 470, 50, 30);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Segoe Print", Font.BOLD, 24));
        question.setBounds(150, 470, 1100, 30);
        add(question);
        ...
        opt1.setFont(new Font("Segoe Print", Font.BOLD, 20));
        opt1.setBackground(Color.WHITE);
        add(opt1);
        
        opt2 = new JRadioButton("");
        opt2.setBounds(170, 560, 700, 30);
        opt2.setFont(new Font("Segoe Print", Font.BOLD, 20));
        opt2.setBackground(Color.WHITE);
        add(opt2);
        
        opt3 = new JRadioButton("");
        opt3.setBounds(170, 600, 700, 30);
        opt3.setFont(new Font("Segoe Print", Font.BOLD, 20));
        opt3.setBackground(Color.WHITE);
        add(opt3);
        
        opt4 = new JRadioButton("");
        opt4.setBounds(170, 640, 700, 30);
        opt4.setFont(new Font("Segoe Print", Font.BOLD, 20));
        ...
        next.setFont(new Font("Segoe Print", Font.BOLD, 22));
        ...
        lifeline.setFont(new Font("Segoe Print", Font.BOLD, 22));
        ...
        submit.setFont(new Font("Segoe Print", Font.BOLD, 22));
    ...
    public void paint(Graphics g){
        ...
        g.setFont(new Font("Segoe Print", Font.BOLD, 25));
        
        if(timer > 0) {
            g.drawString(time, 1100, 500);
        }else {
            g.drawString("Time Up!!!", 1200, 600);
